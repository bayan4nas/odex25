...
class AccountPayment(models.Model):
    ...
    def action_send_finance_manager(self):
        self.write({'state': 'finance_manager'})

    def action_send_sector_manager(self):
        self.write({'state': 'sector_manager'})

    def action_send_secretary_general(self):
    ...
    def action_sector_head_approval(self):
        self._check_permission('odex25_account_payment_fix.group_sector_head_approval_account')
        self.state_history = self.state
