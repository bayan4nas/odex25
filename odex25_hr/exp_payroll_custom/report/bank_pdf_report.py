...
class PayrollXlsx(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, payslips):
        ...
        if not no_details:
            ...
            row = 4
            if bank_type == 'rajhi':
                sheet.write(3, 2, 'Employee Number', format2)
                sheet.write(3, 3, 'Employee Name', format2)
                sheet.write(3, 4, 'Account #', format2)
                sheet.write(3, 5, 'Bank', format2)
                sheet.write(3, 6, 'Amount', format2)
                sheet.write(3, 7, 'Legal #', format2)
                ...
                sheet.write(4, 2, 'الرقم الوظيفي', format2)
                sheet.write(4, 3, 'إسم الموظف ', format2)
                sheet.write(4, 4, 'رقم الحساب', format2)
                sheet.write(4, 5, 'البنك', format2)
                sheet.write(4, 6, 'المبلغ', format2)
                sheet.write(4, 7, 'رقم الهويه/الإقامة', format2)
