...
class Holidays(models.Model):
    ...
    def write(self, values):
        ...
        ### remove  context Type conflict attachment start
        remove_type = dict(self.env.context)
        if remove_type.get('default_type',False):
           del remove_type['default_type']
        self.env.context = remove_type
        ### remve  context Type conflict attachment end
