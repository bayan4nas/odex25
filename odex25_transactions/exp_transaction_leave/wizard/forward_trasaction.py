...
class ForwardTransactionWizard(models.TransientModel):
    ...
    #     print(transaction.last_forwarded_user.name, 'transaction.last_forwarded_user')
    #     print(transaction.forward_user_id.name, 'transaction.forward_user_id')
    #     print(transaction.forward_user_id.nameeeee, 'transaction.forward_user_id')
    #     if self.is_secret:
