...
class FamilyMember(models.Model):
    ...
    family_file_link_family_need_class_id =fields.Many2one(   'family.need.category',related='family_file_link.family_need_class_id',string='Needs Assessment', readonly=True)
